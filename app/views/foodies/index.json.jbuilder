json.array!(@foodies) do |foody|
  ...
  if foody.category == 1
    json.cafe foody,:id,:address, :description, :photos, :category
  elsif foody.category == 2
     json.bar foody,:id, :address, :description, :photos, :category
  elsif foody.category == 3
     json.restaurant foody,:id, :address, :description, :photos, :category
  end
